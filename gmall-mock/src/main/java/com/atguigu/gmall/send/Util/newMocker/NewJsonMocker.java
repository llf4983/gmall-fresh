package com.atguigu.gmall.send.Util.newMocker;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.atguigu.gmall.send.Util.*;
...
public class NewJsonMocker {
    ...
    public NewJsonMocker( )  {

    }

    public NewJsonMocker(String startTimeString , String endTimeString, int startupNum, int eventNum) {
        try {
    ...
    public static void genLog() {
        NewJsonMocker jsonMocker = new NewJsonMocker();
